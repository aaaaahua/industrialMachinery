<template>
	<div id="Index">
		...
		<Collapse v-model="value2" accordion style="width: 314px;float: left;">
			<Panel name="1">
				史蒂夫·乔布斯
			...
			<Panel name="2">
				斯蒂夫·盖瑞·沃兹尼亚克
				<p slot="content">斯蒂夫·盖瑞·沃兹尼亚克（Stephen Gary Wozniak），美国电脑工程师，曾与史蒂夫·乔布斯合伙创立苹果电脑（今之苹果公司）。斯蒂夫·盖瑞·沃兹尼亚克曾就读于美国科罗拉多大学，后转学入美国著名高等学府加州大学伯克利分校</p>
			</Panel>
			<Panel name="3">
				乔纳森·伊夫
